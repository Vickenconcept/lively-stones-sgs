        ...
        <div class="overflow-x-auto bg-white shadow-md sm:rounded-lg">
            <table class="min-w-full divide-y divide-gray-200 mt-2">
                <thead class="bg-gray-100">
                    <tr>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-semibold text-gray-800 uppercase tracking-wider">Name
                        </th>
                        <th scope="col"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <div class="flex space-x-3">
                                    <a href="{{ route('classrooms.show', $classroom) }}"
                                        class="bg-yellow-600 text-white px-3 text-xs py-2 rounded hover:underline">Go to</a>
                                    @role(['super-admin', 'admin'])
